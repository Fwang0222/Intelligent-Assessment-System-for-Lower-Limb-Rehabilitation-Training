...
class AnalysisPage(BasePage):
    ...
    def setup_ui(self) -> None:
        ...
        if MATPLOTLIB_OK:
            self.score_fig = Figure(figsize=(6.2, 3.6), dpi=100)
            self.score_canvas = FigureCanvas(self.score_fig)
            self.dist_fig = Figure(figsize=(6.2, 3.6), dpi=100)
        ...
        self.plan_label = self._create_detail_block(detail_grid, 1, 1, "Plan Recommendation")
    ...
    def _render_charts(self, trend_rows, error_dist, comp_dist) -> None:
        ...
        if trend_rows:
            ...
            ax1.set_ylim(0, 100)
            ax1.set_title("Score & Completion Trend")
        ...
        if values:
            ...
            ax2.set_title("Error & Compensation Distribution")
    ...
    def refresh_data(self) -> None:
        ...
        if adjustments:
            ...
            plan_lines.append("Recent adjustments:")
