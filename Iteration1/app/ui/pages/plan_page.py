...
from PySide6.QtWidgets import QFormLayout, QHBoxLayout, QHeaderView, QTableWidgetItem
...
class PlanPage(BasePage):
    ...
    def setup_ui(self) -> None:
        ...
        desc = BodyLabel("Create plan, run adaptive suggestion, and manage active program.")
        desc.setFixedHeight(22)
        ...
        self.suggestion_text.setFixedHeight(120)
        self.current_suggestion = None
        form_card_layout.addWidget(self.suggestion_text)
        self.main_layout.addWidget(form_card)

        table_card, table_card_layout = self.create_section_card("Plans Table")
