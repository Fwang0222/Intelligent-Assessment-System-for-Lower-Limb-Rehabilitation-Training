"""Login dialog for the V5 local processing + cloud-data demo accounts."""

from PySide6.QtCore import Qt
from PySide6.QtWidgets import QDialog, QFormLayout, QHBoxLayout, QMessageBox, QVBoxLayout

from app.ui.fluent_compat import BodyLabel, FormLabel, LineEdit, PrimaryPushButton, PushButton, SubtitleLabel
...
class RegisterDialog(QDialog):
    ...
    def setup_ui(self) -> None:
        ...
        form.addRow(FormLabel("Username:"), self.username_edit)
        form.addRow(FormLabel("Password:"), self.password_edit)
        form.addRow(FormLabel("Full name:"), self.full_name_edit)
        form.addRow(FormLabel("Gender:"), self.gender_edit)
        form.addRow(FormLabel("Age:"), self.age_edit)
        form.addRow(FormLabel("Height (cm):"), self.height_edit)
        form.addRow(FormLabel("Weight (kg):"), self.weight_edit)
        form.addRow(FormLabel("Injured part:"), self.injury_edit)
        form.addRow(FormLabel("Affected side:"), self.side_edit)
        form.addRow(FormLabel("Rehab stage:"), self.stage_edit)
        form.addRow(FormLabel("Rehab goal:"), self.goal_edit)
        form.addRow(FormLabel("Phone:"), self.phone_edit)
...
class LoginDialog(QDialog):
    ...
    def setup_ui(self) -> None:
        ...
        layout.addWidget(BodyLabel(f"Data backend: {self.db.storage_label()} | Processing: local workstation"))
